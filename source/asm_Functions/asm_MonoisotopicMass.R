# code snippet adapted from work of Nathan Dodder's Org Mass Spec R package:
# https://cran.r-project.org/web/packages/OrgMassSpecR/index.html
# https://github.com/OrgMassSpec/OrgMassSpecR

asm_MonoisotopicMass <- function(formula = list(), isotopes = list(), charge = 0) {
    
    defaultFormula <- list(C = 0, 
                           H = 0,
                           D = 0,
                           N = 0, 
                           O = 0, 
    ...
    mass <- (defaultFormula$C * defaultIsotopes$C + 
             ...
             defaultFormula$D * defaultIsotopes$D +
             ...
             defaultFormula$I * defaultIsotopes$I +
             defaultFormula$Na * defaultIsotopes$Na +
             defaultFormula$K * defaultIsotopes$K +
