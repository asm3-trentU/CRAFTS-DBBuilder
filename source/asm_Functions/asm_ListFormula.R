# Code snippet adapted from OrgMassSpecR 
# https://github.com/OrgMassSpec/OrgMassSpecR/blob/master/OrgMassSpecR/R/ListFormula.R


asm_ListFormula <- function(elemental.formula) {
  ...
  for (i in 1:length(chr[[1]])) {
    ...
    if (!(z == "C" | z =="H" | z == "D" | z =="N" | z =="O" | z =="S" | z =="P"
          | z =="Br" | z =="Cl" | z =="F" | z =="I" | z =="Si" | z=="Sn" | z == "Na" | z=="K"))
      warning(paste("Elemental formula", elemental.formula,
                    "contains element not of C,H,D,N,O,S,P,Br,Cl,F,I,Si,Sn,Na,K."))
  }
  ...
  elements <- c("C", "H", "D", "N", "O", "S", "P", "Br", "Cl", "F", "I", "Si", "Sn", "Na", "K")
