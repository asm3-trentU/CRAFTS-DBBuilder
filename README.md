...
Current Software Maintainers:
(2026-Present) Daphne Maki - daphnemaki@trentu.ca
(2025-Present) Arun Moorthy - arunmoorthy@trentu.ca
...
A peer-reviewed technical note to accompany this source code has been published through the Journal of the American Scoeity for Mass Spectrometry: [Moorthy et al., 2025](https://doi.org/10.1021/jasms.5c00382)
...
For more information about this project or if you'd like help modifying this code, please contact Arun. We  have a [video describing the set up and use of the database builder scripts](https://youtu.be/8SHJQU7m15s?si=S2LhStZ2_spB4OtS) and a [video explaining how to set up a custom library with the NIST/NIJ DIT](https://youtu.be/u9KUriMjC8Q?si=WW0xI07yvGJPetsI) availble through the [CRAFTS Lab youtube channel](https://youtube.com/@craftslab-trentu?si=MC6UjEBhxWv0n4yo). 
